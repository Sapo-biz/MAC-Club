...
document.addEventListener('DOMContentLoaded', () => {
    const elementsToAnimate = document.querySelectorAll('.activity-card, .project-category, .feature-card, .about-text, .join-text');
...
document.addEventListener('DOMContentLoaded', () => {
    const cards = document.querySelectorAll('.activity-card, .project-category, .feature-card');
